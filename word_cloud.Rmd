...
wine_top10_word <- function(wine_subset){
  ...
  other_meaningless <- data.frame(word = c("wine","drink","flavors","notes","finish", "structure", "blend", "age",  "palate", "cabernet", "pinot","noir", "chardonnay", "aromas", "black", "red", "wine", "rose", "rosé", "sparkling"))
  wine_word = 
    wine_word %>% 
