...
Below are several choropleth maps depicting where wines are made and the average ratings and prices for each country.
...
There are 2 interactive maps, one for US states and a world map. The interactive maps allows for users to hover over a specific US state or country of interest, and look at the total number of wines in our database from that particular state or country, along with their average ratings and prices. 
