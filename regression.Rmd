...
* **Missing Data**: There were `r read_csv("./wine_data/tidy/wine_red.csv") %>% is.na(price) %>% nrow()` in the red wine dataset and `r read_csv("./wine_data/tidy/wine_white.csv") %>% is.na(price) %>% nrow()` in the white wine dataset.
