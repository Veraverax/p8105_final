...
output: 
  html_document:
    ...
    toc_float: true
---
<h1 style="text-align: center;" markdown="1">Project Report

<h4 style="text-align: center;" markdown="1">Vera Xu (yx2578) | Tianheng Hu (th2533) | Helen Zhang (hlz2108) | Yuanxin Zhang (yz3736)</h6>

<br>

This is the report of our wine data project.
...
Wine is one of the most commonly seen alcoholic drinks, and there is a great amount of knowledge about wine history, wine categories and what characterizes a great bottle of wine.
...
We firstly imported the raw dataset, and created a **Year extracting function**. This function is used to extract the wine vintage information from the wine name.
