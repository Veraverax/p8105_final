...
##### Coding Challenges: 
1\) Extract notes information from text description; 2) Generate coordinates using packages; 3) Level of significance of the regression model; 4) Dealing with missing/duplicate data
