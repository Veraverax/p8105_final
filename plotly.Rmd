...
The results is significant which means that we can conclude that at least one wine type's price is differnet from the others.
...
Even though Switzerland has the highest priced wine, the average ratings is only ranked at 11. Wine in Switzerlan is not very recommended. 
...
# Trend of wine prices over time
...
# Trend of wine ratings over time
...
## Conduct a ANOVA test on price vs new/old world wine
